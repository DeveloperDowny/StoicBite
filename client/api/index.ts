...
axiosClient.defaults.baseURL = "https://app-v-2-ykritkfgoa-uc.a.run.app";
...
export function cleanUnusualCharacters(text) {
...
function parseQuoteResponse(data) {
  ...
  const explanation = cleanUnusualCharacters(data.explanation);
